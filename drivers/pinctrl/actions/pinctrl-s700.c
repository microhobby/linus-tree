...
/* PAD_GPIOA */
static PAD_GPIO_CONF(ETH_MDC, 0x0000, 22, 1);
static PAD_GPIO_CONF(ETH_MDIO, 0x0000, 23, 1);
static PAD_GPIO_CONF(I2S_D0, 0x0000, 27, 1);
static PAD_GPIO_CONF(I2S_D1, 0x0000, 31, 1);

/* PAD_GPIOB */
static PAD_GPIO_CONF(LVDS_OEP, 0x000C, 10, 1);
static PAD_GPIO_CONF(LVDS_OEN, 0x000C, 11, 1);
static PAD_GPIO_CONF(LVDS_ODP, 0x000C, 12, 1);
static PAD_GPIO_CONF(LVDS_ODN, 0x000C, 13, 1);
static PAD_GPIO_CONF(LVDS_OCP, 0x000C, 14, 1);
static PAD_GPIO_CONF(LVDS_OCN, 0x000C, 15, 1);
static PAD_GPIO_CONF(LVDS_OBP, 0x000C, 16, 1);
static PAD_GPIO_CONF(LVDS_OBN, 0x000C, 17, 1);
static PAD_GPIO_CONF(LVDS_OAN, 0x000C, 19, 1);
static PAD_GPIO_CONF(LVDS_EEP, 0x000C, 20, 1);
static PAD_GPIO_CONF(LVDS_EEN, 0x000C, 21, 1);
static PAD_GPIO_CONF(LVDS_EDP, 0x000C, 22, 1);
static PAD_GPIO_CONF(LVDS_EDN, 0x000C, 10, 1);
static PAD_GPIO_CONF(LVDS_ECP, 0x000C, 10, 1);
static PAD_GPIO_CONF(LVDS_ECN, 0x000C, 10, 1);
static PAD_GPIO_CONF(LVDS_EBP, 0x000C, 10, 1);
static PAD_GPIO_CONF(LVDS_EBN, 0x000C, 10, 1);
static PAD_GPIO_CONF(LVDS_EAP, 0x000C, 10, 1);
static PAD_GPIO_CONF(LVDS_EAN, 0x000C, 10, 1);
static PAD_GPIO_CONF(LCD0_D18, 0x000C, 10, 1);
static PAD_GPIO_CONF(DSI_DP3, 0x000C, 10, 1);
static PAD_GPIO_CONF(DSI_DN1, 0x000C, 10, 1);
static PAD_GPIO_CONF(SD1_CLK, 0x000C, 10, 1);
static PAD_GPIO_CONF(SENSOR0_CKOUT, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_ALE, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_CLE, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_CEB0, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_CEB1, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_CEB2, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_CEB3, 0x000C, 10, 1);
static PAD_GPIO_CONF(UART3_TX, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DN0, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DP0, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DN1, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DP1, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_CN, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_CP, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DN2, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DP2, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DN3, 0x000C, 10, 1);
static PAD_GPIO_CONF(CSI_DP3, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_WRB, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_RDB, 0x000C, 10, 1);
static PAD_GPIO_CONF(DNAND_RB0, 0x000C, 10, 1);
static PAD_GPIO_CONF(PORB, 0x0000, 0, 0);
static PAD_GPIO_CONF(BSEL, 0x0000, 0, 0);
static PAD_GPIO_CONF(PKG0, 0x0000, 0, 0);
static PAD_GPIO_CONF(PKG1, 0x0000, 0, 0);
static PAD_GPIO_CONF(PKG2, 0x0000, 0, 0);
static PAD_GPIO_CONF(PKG3, 0x0000, 0, 0);
static PAD_GPIO_CONF(I2S_BCLK1, 0x0000, 0, 0);
